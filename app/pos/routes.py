...
def consulta_admin(dia: str):
    """Menu query for admin/pos users: returns real menus without time restrictions.

    Rezagados virtual menu is never included so admin always sees real options.
    """
    from ..routes import obtiene_menues
